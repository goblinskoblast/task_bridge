...
STOPLIST_WEEKLY_DIGESTS_ENABLED = os.getenv("STOPLIST_WEEKLY_DIGESTS_ENABLED", "false").lower() == "true"
STOPLIST_WEEKLY_DIGEST_DAY_OF_WEEK = os.getenv("STOPLIST_WEEKLY_DIGEST_DAY_OF_WEEK", "mon").strip().lower()
STOPLIST_WEEKLY_DIGEST_HOUR = int(os.getenv("STOPLIST_WEEKLY_DIGEST_HOUR", "11"))
STOPLIST_WEEKLY_DIGEST_MINUTE = int(os.getenv("STOPLIST_WEEKLY_DIGEST_MINUTE", "5"))
STOPLIST_WEEKLY_DIGEST_LOOKBACK_DAYS = int(os.getenv("STOPLIST_WEEKLY_DIGEST_LOOKBACK_DAYS", "7"))
