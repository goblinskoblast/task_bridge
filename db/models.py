...
class DataAgentProfile(Base):
    ...
    reviews_report_chat_id = Column(BigInteger, nullable=True)
    reviews_report_chat_title = Column(String(500), nullable=True)
    stoplist_report_chat_id = Column(BigInteger, nullable=True)
    stoplist_report_chat_title = Column(String(500), nullable=True)
    blanks_report_chat_id = Column(BigInteger, nullable=True)
    blanks_report_chat_title = Column(String(500), nullable=True)
