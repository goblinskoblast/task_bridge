...
ОСНОВНЫЕ КОМАНДЫ:
- /start - Начать работу с ботом и открыть панель задач
- /panel - Быстро открыть веб-панель задач
...
2. **Email интеграция**:
   - Зарегистрируй свой email через кнопку в /start
...
Ответ:
{{
  "response": "Добавить задачу очень просто! 🎯\\n\\nЕсть 2 способа:\\n\\n1️⃣ **В группе**: Напиши сообщение с упоминанием человека:\\n   @alex сделай отчет до завтра\\n\\n2️⃣ **Через панель**: Нажми /panel и используй кнопку '➕ Создать'\\n\\nБот автоматически определит исполнителя, срок и приоритет! Попробуй 😊",
  "category": "question",
